...
const LINKS = [
  ...
  },
  {
    ...
    sub: "@eldomingoeterno",
    href: "https://www.youtube.com/@eldomingoeterno",
    icon: "youtube",
  },
  {
  ...
  return (
    <main style={{
      ...
      <div style={{
        ...
        />
        {/* Overlay: oscuro arriba y abajo, sin rojo */}
        <div style={{
          position: "absolute",
          inset: 0,
      ...
      <div style={{
        ...
        {/* SHOWS */}
        <div className="animate-fade-up delay-2" style={{ width: "100%", marginBottom: "24px" }}>
          <div style={{
            display: "flex",
            alignItems: "center",
            gap: "10px",
        ...
        <div className="animate-fade-up delay-4" style={{
          ...
          border: "0.5px solid rgba(255,225,132,0.12)",
          borderRadius: "3px",
          backdropFilter: "blur(8px)",
          WebkitBackdropFilter: "blur(8px)",
        }}>
          <div style={{
            ...
            <div style={{ width: "16px", height: "0.5px", background: "rgba(255,225,132,0.3)" }} />
            <span style={{
              fontFamily: "'IM Fell English', serif",
              fontStyle: "italic",
              fontSize: "10px",
            ...
            <div style={{ flex: 1, height: "0.5px", background: "rgba(255,225,132,0.3)" }} />
          </div>
          <p style={{
            ...
            fontSize: "14px",
            lineHeight: 1.75,
            color: "rgba(255,225,132,0.65)",
            letterSpacing: "0.02em",
          }}>
            El Domingo Eterno es un trío de rock alternativo de Buenos Aires, formado por Rebeca Rivas (voz y guitarra), Charly Quintero (guitarra y voz) y Ale Garcia (bajo). Dentro del rock alternativo, la banda encuentra sus raíces en los &apos;80 y los &apos;90, con referencias que van desde The Cure y The Smiths hasta The Smashing Pumpkins, construyendo desde ahí un sonido propio.
          </p>
        </div>
        ...
        <div className="animate-fade-up delay-5" style={{
          ...
          borderRadius: "12px",
          overflow: "hidden",
          border: "0.5px solid rgba(255,225,132,0.15)",
        }}>
          <iframe
            src="https://open.spotify.com/embed/artist/65GGdrZ3ogiqwCjrlWogMw?utm_source=generator"
            width="100%"
            height="152"
            frameBorder="0"
